                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-10">
                    {archiveProjects.map((project) => (
                        ...
                        >
                            ...
                            <div className="mb-4 transition-transform duration-300 group-hover:scale-[1.02] flex-shrink-0">
                            ...
                            <div className="flex flex-col flex-grow">
                                ...
                                <div className="flex flex-wrap gap-2 mb-3">
                                    {project.tags.map((tag, tagIndex) => (
                                        <span
                                            key={tagIndex}
                                            className="px-3 py-1 bg-gray-100 text-gray-700 text-xs font-medium rounded-full shadow-sm hover:bg-gray-200 transition-all duration-200"
                                        >
                                            {tag}
                                        </span>
                                    ))}
                                ...
                                {/* 🔹 Project Title */}
                                <h3 className="text-lg md:text-xl font-semibold mb-2 text-gray-800 transition-colors duration-200 line-clamp-2">
                                    {project.title}
                                </h3>

                                {/* 🔹 Project Subtitle / Description */}
                                <p className="text-gray-600 text-sm md:text-base leading-relaxed mb-4 flex-grow line-clamp-3">
                                    {project.subtitle}
                                </p>
